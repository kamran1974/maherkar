...
from .views import (
    ChangePassword, ForgotPassword, Login, RegisterEmployer,
    RegisterJobSeeker, RegisterView, ActiveAccountView,
    get_cities, UserViewSetApiView, reSend_activeCode, logout_view,
    JobSeekerViewSetApiView, EmployerViewSetApiView
)
