...
class AdvertismentAdmin(admin.ModelAdmin):
    ...
    fields = ['advertise_code','employer','title','description_position','province','county','district','salary','job',"job_type","type_of_cooperation",'subscription','created_at','duration','expire_date','gender','soldier_status','degree','skills','check_by_admin','is_show','pay_status','status','display_total_price']
